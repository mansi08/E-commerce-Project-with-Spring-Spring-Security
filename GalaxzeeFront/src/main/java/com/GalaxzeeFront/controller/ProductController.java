...
public class ProductController 
{
	...
	@RequestMapping("/productTotalInfo/{productID}")
	public String ShowTotalProductDisplay(@PathVariable ("productID") int productID, Model model)
	{
		...
		return "ProductTotalInfo"; //another jsp page of name TotalProductInfo
	}
	...
	public String SaveProduct(@ModelAttribute("product")Product product)
	{
		...
		String dir="C:\\Users\\Mansi Gupta\\eclipse-workspace\\GalaxzeeFront\\src\\main\\webapp\\assests\\images\\product\\";
