...
<form:form action="${pageContext.request.contextPath}/${url }"
	...
	Category Name:<form:input path="categoryName" placeholder="CategoryName" /> </br>
	Category Description:<form:input path="categoryDesc" placeholder="CategoryDescription" />  </br></br>
